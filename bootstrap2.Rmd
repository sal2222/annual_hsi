...
hsi_select_heat_season <- hsi_data %>% count(index) %>% View()
  filter(index %in% c("tmp_f_mean_may_sep",             
                      "wbgt_f_may_sep",            
                      "heat_index_may_sep")
)

joined_hsi %>% count(index)
hsi_select_heat_season %>% count(index)

hsi_select <- 
  read_rds("data/hsi_select.rds")
